...
function cargarImagenSeleccionada() {
    var acciones_imagenSeleccionada = sessionStorage.getItem('acciones_imagenSeleccionada');
    if (acciones_imagenSeleccionada) {
        acciones_mostrarPictograma(acciones_imagenSeleccionada);
    }
}

function acciones_mostrarPictograma(src) {
    ...
    if (barraBlanca) {
        ...
        sessionStorage.setItem('acciones_imagenSeleccionada', src);
    }
}
