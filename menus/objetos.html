...
function cargarImagenSeleccionada() {
    var objetos_imagenSeleccionada = sessionStorage.getItem('objetos_imagenSeleccionada');
    if (objetos_imagenSeleccionada) {
        objetos_mostrarPictograma(objetos_imagenSeleccionada);
    }
}

function objetos_mostrarPictograma(src) {
    ...
    if (barraBlanca) {
        ...
        sessionStorage.setItem('objetos_imagenSeleccionada', src);
    }
}
