...
function cargarImagenSeleccionada() {
    var respuestas_imagenSeleccionada = sessionStorage.getItem('respuestas_imagenSeleccionada');
    if (respuestas_imagenSeleccionada) {
        respuestas_mostrarPictograma(respuestas_imagenSeleccionada);
    }
}

function respuestas_mostrarPictograma(src) {
    ...
    if (barraBlanca) {
        ...
        sessionStorage.setItem('respuestas_imagenSeleccionada', src);
    }
}
