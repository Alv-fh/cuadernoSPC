...
function cargarImagenSeleccionada() {
    var personas_imagenSeleccionada = sessionStorage.getItem('personas_imagenSeleccionada');
    if (personas_imagenSeleccionada) {
        personas_mostrarPictograma(personas_imagenSeleccionada);
    }
}

function personas_mostrarPictograma(src) {
    ...
    if (barraBlanca) {
        ...
        sessionStorage.setItem('personas_imagenSeleccionada', src);
    }
}
